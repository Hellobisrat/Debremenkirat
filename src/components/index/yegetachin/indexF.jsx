...
const days = [
  { label:"ድንቅ አድርጎልኛል የሠራዊት ጌታ ", link: "/song/yegetachin/dinkadergolegal" },
  {label:"በፍቅር ተስቦ ወረደ ለኛ ሲል ", link:"/song/yegetachin/befikirtesbo" },
  {label:"ኒቆዲሞስ ኒቆዲሞስ ክቡር",link:"/song/yegetachin/nikodimos"},
  {label:"የይሁዳ ጉዞ አያዋጣምና", link:"/song/yegetachin/yeyehuda"},
  {label:"እግዚአብሔር ሆይ ወሮታህ ብዙ ነው",link:"/song/yegetachin/egziabherhoye"},
  {label:"ግነዩ ለእግዚአብሔር እስመ ኄር ",link:"/song/yegetachin/gineyu"},
  {label:"እሰይ እሰይ ተወለደ",link:"/song/yegetachin/eseye"},
